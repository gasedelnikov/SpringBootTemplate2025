...
public class SecurityConfiguration {
    public static final RequestMatcher PUBLIC_URLS = new OrRequestMatcher(
            ...
            PathPatternRequestMatcher.withDefaults().matcher("/auth/registration"),
            PathPatternRequestMatcher.withDefaults().matcher("/swagger/swagger-ui/**"),
            PathPatternRequestMatcher.withDefaults().matcher("/swagger/swagger-resources/*"),
